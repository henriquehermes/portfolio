...
const pageData: PageData = {
	...
	dutiesAndResponsibilities:
		"Dolado (Darez) is an innovative B2B company at the forefront of e-commerce, leveraging cutting-edge technologies to redefine the online shopping experience. The dedicated team was proficient in NextJS with TypeScript, ensuring the development of a robust and dynamic platform. We had seamlessly integrated the powerful Shopify API, providing seamless connectivity and enhancing functionality. Additionally, our expertise extended to developing pilot projects using React Native, enabling our clients to tap into the rapidly growing mobile market. At Dolado, I was committed to delivering exceptional solutions that propel businesses forward in the digital landscape.",
	tasks: [
