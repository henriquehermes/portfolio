...
const pageData: PageData = {
	...
	color: "#13E58A",
	dutiesAndResponsibilities: `As a ReactJS and React Native Engineer, I have had the privilege of working on a project that focused on revolutionizing the financial sector. Within this dynamic environment, I played a pivotal role in developing web projects using ReactJS and crafting mobile applications using React Native. At DX.CO (A company from 4all), our overarching mission is to positively transform the daily lives of individuals through exceptional digital products and services. To achieve this, we have 	established a Technology Hub that nurtures and invests in sector-specific startups, driving digital transformation forward. Our close integration with the Investment Venture and strategic partners creates a powerful ecosystem that fuels collaboration, inspires innovation, and facilitates meaningful connections vital for the success of our projects.`,
	tasks: [
